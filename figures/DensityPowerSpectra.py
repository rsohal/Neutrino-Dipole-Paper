...
py.figure(1)
py.clf()
py.loglog(nunu1[:,0], nunu1[:,1], 'r', label=r"$0-5214 km/s$")
py.loglog(nunu2[:,0], nunu2[:,1], 'b', label=r"$5214-7853 km/s$")
py.loglog(nunu3[:,0], nunu3[:,1], 'g', label=r"$7853-11280 km/s$")
py.loglog(nunu4[:,0], nunu4[:,1], 'k', label=r"$>11280 km/s$")
